...
class TestDetectFileType:
    ...
    def test_detect_docx_by_magic_bytes(self):
        ...
        assert (
            detect_file_type(docx_header) == "application/vnd.openxmlformats-officedocument.wordprocessingml.document"
        )
...
class TestExtractTextFromFile:
    ...
    def test_extract_text_from_plain_text(self):
        ...
        mock_file = MockFile(content=text_content, filename="cv.txt", mime_type="text/plain")
