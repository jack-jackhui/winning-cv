...
class TestCVVersionsSchema:
    ...
    def test_version_id_is_unique(self, schema_content):
        ...
        assert (
            "version_id VARCHAR(50) NOT NULL UNIQUE" in schema_content
            or "UNIQUE INDEX" in schema_content
            and "version_id" in schema_content
...
class TestJobsSchema:
    ...
    def test_next_action_is_calendar_date(self, schema_content):
        ...
        assert "ON jobs(user_email, next_action_at, created_at DESC, id)" in schema_content
...
class TestSearchTasksSchema:
    ...
    def test_task_id_is_unique(self, schema_content):
        ...
        assert "task_id VARCHAR(50) NOT NULL UNIQUE" in schema_content, "task_id should be UNIQUE"
