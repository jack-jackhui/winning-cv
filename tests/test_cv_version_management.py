...
class TestAPISchemas:
    ...
    def test_cv_match_request_schema(self):
        ...
        data = {"job_description": job_desc, "job_title": "Software Engineer", "company_name": "TechCorp", "limit": 3}
...
class TestFrontendComponents:
    ...
    def test_cv_library_jsx_syntax(self):
        ...
        frontend_path = os.path.join(
            os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "frontend", "src", "pages", "CVLibrary.jsx"
        )
    ...
    def test_cv_analytics_jsx_syntax(self):
        ...
        frontend_path = os.path.join(
            os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "frontend", "src", "pages", "CVAnalytics.jsx"
        )
    ...
    def test_generate_cv_integration(self):
        ...
        frontend_path = os.path.join(
            os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "frontend", "src", "pages", "GenerateCV.jsx"
        )
    ...
    def test_app_routes(self):
        ...
        frontend_path = os.path.join(
            os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "frontend", "src", "App.jsx"
        )
    ...
    def test_api_service(self):
        ...
        frontend_path = os.path.join(
            os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "frontend", "src", "services", "api.js"
        )
