...
// OAuth provider icons as inline SVGs
const GoogleIcon = () => (
...
export default function Login() {
  ...
  const providers = [
    ...
    },
    {
      ...
      name: 'GitHub',
      icon: GitHubIcon,
      bgClass: 'bg-[#24292F] hover:bg-[#32383F]',
      textClass: 'text-white',
    },
  ]
    ...
    <div className="min-h-[calc(100vh-5rem)] flex items-center justify-center py-12 px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-text-primary">Welcome to WinningCV</h1>
          <p className="mt-2 text-text-secondary">
            Sign in to start generating tailored CVs
          </p>
        </div>
          ...
          {providers.map((provider) => (
            <button
              ...
              className={`
                ...
                font-medium transition-colors duration-200 border border-border
