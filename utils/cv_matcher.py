...
class CVVersionMatcher:
    ...
    def match_versions(
        ...
        return {"suggestions": scored_versions[:limit], "job_analysis": job_analysis}

    def _analyze_job(
        self, job_description: str, job_title: Optional[str] = None, company_name: Optional[str] = None
    ) -> Dict[str, Any]:
    ...
    def _score_version(self, version: Dict[str, Any], job_analysis: Dict[str, Any]) -> Dict[str, Any]:
        """Score a CV version against job analysis."""
        scores = {"role_similarity": 0, "skills_overlap": 0, "category_match": 0, "performance_bonus": 0}
        reasons = []
        ...
        weights = {"role_similarity": 0.35, "skills_overlap": 0.35, "category_match": 0.15, "performance_bonus": 0.15}
